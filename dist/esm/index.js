...
function Map$1(_a) {
    ...
    var backgroundRef = reactExports.useRef(null);
    var bodyRef = reactExports.useRef(null);
    var _g = reactExports.useState("0"), width = _g[0], setWidth = _g[1];
    var _h = reactExports.useState([]), items = _h[0], setItems = _h[1];
